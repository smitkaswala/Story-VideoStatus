...
public class InnerNewAdapter extends RecyclerView.Adapter<InnerNewAdapter.ViewHolder> {
    ...
    public InnerNewAdapter(List<ResponseNew> responseNewList,Activity activity) {
    ...
    @NonNull
    @Override
    public InnerNewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_list_items,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull InnerNewAdapter.ViewHolder holder, int position) {
