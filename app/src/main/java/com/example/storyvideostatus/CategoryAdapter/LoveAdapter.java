package com.example.storyvideostatus.CategoryAdapter;
...
public class LoveAdapter extends RecyclerView.Adapter<LoveAdapter.ViewHolder> {
    ...
    List<ResponseCategory> responseNewList;
    Activity activity;
    private DownloadClickListener mDownloadClickListener;

    public LoveAdapter(List<ResponseCategory> responseNewList,Activity activity){
    ...
    @NonNull
    @Override
    public LoveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_list_items,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LoveAdapter.ViewHolder holder, int position) {
    ...
    public void addAll(List<ResponseCategory> responseNews){
