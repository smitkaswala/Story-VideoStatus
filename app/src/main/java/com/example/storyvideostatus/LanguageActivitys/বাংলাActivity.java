...
public class বাংলাActivity extends BaseActivity implements HindiAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(বাংলাActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new HindiAdapter(responseNewList, বাংলাActivity.this);
...
//                            getStoryStatusVideos(pageCount);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(বাংলাActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
