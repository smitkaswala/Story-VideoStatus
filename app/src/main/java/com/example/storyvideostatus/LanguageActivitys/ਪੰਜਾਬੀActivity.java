...
public class ਪੰਜਾਬੀActivity extends BaseActivity implements HindiAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ਪੰਜਾਬੀActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new HindiAdapter(responseNewList, ਪੰਜਾਬੀActivity.this);
...
//                            getStoryStatusVideos(pageCount);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(ਪੰਜਾਬੀActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
