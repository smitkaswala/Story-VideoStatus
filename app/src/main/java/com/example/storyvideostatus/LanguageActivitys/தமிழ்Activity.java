...
public class தமிழ்Activity extends BaseActivity implements HindiAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(தமிழ்Activity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new HindiAdapter(responseNewList, தமிழ்Activity.this);
...
//                            getStoryStatusVideos(pageCount);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(தமிழ்Activity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
