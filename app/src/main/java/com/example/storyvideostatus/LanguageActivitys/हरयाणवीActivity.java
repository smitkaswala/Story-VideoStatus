...
public class हरयाणवीActivity extends BaseActivity implements HindiAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(हरयाणवीActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new HindiAdapter(responseNewList, हरयाणवीActivity.this);
...
//                            getStoryStatusVideos(pageCount);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(हरयाणवीActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
