...
public class मराठीActivity extends BaseActivity implements HindiAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(मराठीActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new HindiAdapter(responseNewList, मराठीActivity.this);
...
//                            getStoryStatusVideos(pageCount);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(मराठीActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
