...
public class AttitudeActivity extends BaseActivity implements LoveAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(AttitudeActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new LoveAdapter(responseNewList, AttitudeActivity.this);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(AttitudeActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
