...
public class DanceActivity extends BaseActivity implements LoveAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DanceActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new LoveAdapter(responseNewList, DanceActivity.this);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(DanceActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
