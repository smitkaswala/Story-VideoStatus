...
public class RomanticActivity extends BaseActivity implements LoveAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(RomanticActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new LoveAdapter(responseNewList, RomanticActivity.this);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(RomanticActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
