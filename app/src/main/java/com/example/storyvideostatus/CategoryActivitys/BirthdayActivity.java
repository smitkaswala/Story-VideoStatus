...
public class BirthdayActivity extends BaseActivity implements LoveAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(BirthdayActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new LoveAdapter(responseNewList, BirthdayActivity.this);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(BirthdayActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
...
//        startActivity(intent);
        // avi rite ama karyu toh aa ok chale che
        finish();
    }
