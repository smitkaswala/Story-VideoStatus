...
public class SadActivity extends BaseActivity implements LoveAdapter.DownloadClickListener {
    ...
    private void setAdapter() {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SadActivity.this, RecyclerView.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        innerNewAdapter = new LoveAdapter(responseNewList, SadActivity.this);
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(SadActivity.this, new MediaScannerConnection.MediaScannerConnectionClient() {
